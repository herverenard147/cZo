...
class CategoriesMenage extends StatefulWidget {
  const CategoriesMenage({super.key});
  @override
  State<CategoriesMenage> createState() => _CategoriesMenageState();
}

class _CategoriesMenageState extends State<CategoriesMenage> {
